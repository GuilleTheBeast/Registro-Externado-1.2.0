CREATE DATABASE  IF NOT EXISTS `externadodb` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `externadodb`;
...
INSERT INTO `externado_admin` VALUES (1,'Administrador','Principal','',1,'2023-11-03 14:21:38');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_admin_system` (
...
INSERT INTO `externado_admin_system` VALUES (1,'MAT_2023','2022-2023',1,1);
...
INSERT INTO `externado_church` VALUES (0,'Favor seleccionar un valor'),(1,'Mormones'),(2,'Luterana'),(3,'Adventista'),(4,'Bautista'),(5,'Asambleas de Dios'),(6,'Testigos de Jehová'),(7,'Unión Centroamericana'),(8,'Tabernáculo bíblico bautista'),(9,'Otra');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_department` (
...
INSERT INTO `externado_department` VALUES (0,'Favor seleccionar un valor'),(1,'Ahuachapán'),(2,'Cabañas'),(3,'Chalatenango'),(4,'Cuscatlán'),(5,'La Libertad'),(6,'La Paz'),(7,'La Unión'),(8,'Morazán'),(9,'San Miguel'),(10,'San Salvador'),(11,'San Vicente'),(12,'Santa Ana'),(13,'Sonsonate'),(14,'Usulután');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_incoming` (
...
INSERT INTO `externado_incoming` VALUES (0,'Favor seleccionar un valor'),(1,'Desde $0 a $500 dólares mensuales'),(2,'Desde $501 a $1,000 dólares mensuales'),(3,'Desde $1,001 a $1,500 dólares mensuales'),(4,'Desde $1,501 a $2,000 dólares mensuales'),(5,'Desde $2,001 a $2,500 dólares mensuales'),(6,'Desde $2,501 a $3,000 dólares mensuales'),(7,'Otro');
...
INSERT INTO `externado_level` VALUES (0,'Favor seleccionar un valor'),(1,'Parvularia 4'),(2,'Parvularia 5'),(3,'Preparatoria'),(4,'Primero'),(5,'Segundo'),(6,'Tercero'),(7,'Cuarto Matutino'),(8,'Cuarto Vespertino'),(9,'Quinto Matutino'),(10,'Quinto Vespertino'),(11,'Sexto Matutino'),(12,'Sexto Vespertino'),(13,'Séptimo Matutino'),(14,'Séptimo Vespertino'),(15,'Octavo Matutino'),(16,'Octavo Vespertino'),(17,'Noveno Matutino'),(18,'Noveno Vespertino'),(19,'Primero de Bachillerato'),(20,'Segundo de Bachillerato');
...
INSERT INTO `externado_pep` VALUES (4,'Alcalde'),(8,'Asistente de oficina del GOES'),(3,'Diputado/a'),(6,'Diputado/a suplente'),(0,'Favor seleccionar un valor'),(5,'Juez/a'),(1,'Ministro/a'),(10,'Otro'),(7,'Secretario privado/a de GOES'),(9,'Sindicalista de Institución Gubernamental'),(2,'Viceministro/a');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_responsible` (
  ...
  KEY `fk_pep_responsible_id_idx` (`externado_pep_occupation_id`,`externado_pep_3years_occupation_id`),
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_responsible_type` (
...
INSERT INTO `externado_responsible_type` VALUES (1,'Mamá'),(2,'Papá'),(3,'Tutor Legal');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_sequence` (
...
INSERT INTO `externado_sequence` VALUES (1,2,2,1,1,2,21,15,11,8,10);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_student` (
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_student_responsible_type` (
...
INSERT INTO `externado_student_responsible_type` VALUES (0,'Favor seleccionar un valor'),(1,'Mamá'),(2,'Papá'),(3,'Mamá y Papá'),(4,'Otro');
...
INSERT INTO `externado_user` VALUES (1,'matricula@externado.edu.sv','$2b$12$VAw/kIZ.mhjqVDMbxUYP/uC0/rAuy5NyACyjPeVuOIPCS.ZjVNMEu',1,1,0,'MAT_2023',1,0,'c12b1c92-93c8-510c-b425-e38f3783a721','2023-10-23 17:16:48');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `externado_user_type` (
...
INSERT INTO `externado_user_type` VALUES (2,'Admin'),(1,'Super Admin'),(3,'User');
