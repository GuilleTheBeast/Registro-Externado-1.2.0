...
const Listarepresentantes = ({ setShowNavbar }) => {
  useEffect(() => {
  ...
  const handleEditClick = (responsableId) => () => {
    navigate(`/inforesponsables/${responsableId}`);
  };
    ...
    <>
      ...
      <div className="system-parameters-container">
        ...
        <>
          ...
          <ul>
            <li>
              Al presionar el ícono en Acciones, se brinda la información del
              responsable.
            </li>
          </ul>
        </>
                ...
                <tr key={index}>
                  ...
                  >
                    <Button
                      variant="link"
                      className="p-0"
                      onClick={handleEditClick(d.idexternado_responsible)}
                    >
